...
export function EditorMap({
  ...
  return (
    <div className="relative w-full h-full" data-editor-map="true">
      <MapContainer
      ...
      >
        ...
        {activeCourse && midstation && (
          ...
          >
            <LeafletTooltip>中間駅</LeafletTooltip>
          </Marker>
        )}
      </MapContainer>

      <div className="absolute top-2.5 right-2.5 z-20 flex flex-col gap-1 bg-white rounded-md shadow-sm p-1.5">
        ...
        {googleUnavailable && (
          <p className="text-xs text-red-500 max-w-[140px]">
